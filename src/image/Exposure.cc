...
Exposure<ImageT, MaskT, VarianceT>::Exposure(std::string const &fileName, lsst::geom::Box2I const &bbox,
        ...
        : _maskedImage(), _info(new ExposureInfo()) {
