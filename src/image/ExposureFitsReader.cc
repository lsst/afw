...
std::shared_ptr<table::io::Persistable> ExposureFitsReader::readComponent(std::string const &componentName) {
    _ensureReaders();
    return _archiveReader->readComponent<table::io::Persistable>(_getFitsFile(), componentName);
}
