...
PTR(io::FitsWriter) BaseTable::makeFitsWriter(fits::Fits * fitsfile, PTR(io::OutputArchive) archive) const {
    return boost::make_shared<io::FitsWriter>(fitsfile, archive);
}
