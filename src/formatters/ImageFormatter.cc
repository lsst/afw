...
void ImageFormatter<ImagePixelT>::write(
    ...
    LOGL_TRACE9(_log, "ImageFormatter write start");
    ...
    if (typeid(*storage) == typeid(BoostStorage)) {
        LOGL_TRACE9(_log, "ImageFormatter write BoostStorage");
        BoostStorage* boost = dynamic_cast<BoostStorage*>(storage.get());
        boost->getOArchive() & *ip;
        LOGL_TRACE9(_log, "ImageFormatter write end");
        return;
    }
    else if (typeid(*storage) == typeid(XmlStorage)) {
        LOGL_TRACE9(_log, "ImageFormatter write XmlStorage");
        ...
        LOGL_TRACE9(_log, "ImageFormatter write FitsStorage");
...
Persistable* ImageFormatter<ImagePixelT>::read(Storage::Ptr storage,
    ...
    LOGL_TRACE9(_log, "ImageFormatter read start");
    if (typeid(*storage) == typeid(BoostStorage)) {
        LOGL_TRACE9(_log, "ImageFormatter read BoostStorage");
        BoostStorage* boost = dynamic_cast<BoostStorage*>(storage.get());
        Image<ImagePixelT>* ip = new Image<ImagePixelT>;
        boost->getIArchive() & *ip;
        LOGL_TRACE9(_log, "ImageFormatter read end");
        return ip;
    }
    else if (typeid(*storage) == typeid(XmlStorage)) {
        LOGL_TRACE9(_log, "ImageFormatter read XmlStorage");
        XmlStorage* boost = dynamic_cast<XmlStorage*>(storage.get());
        Image<ImagePixelT>* ip = new Image<ImagePixelT>;
        ...
        LOGL_TRACE9(_log, "ImageFormatter read FitsStorage");
        FitsStorage* fits = dynamic_cast<FitsStorage*>(storage.get());
        geom::Box2I box;
...
void ImageFormatter<ImagePixelT>::delegateSerialize(
    ...
    LOGL_TRACE9(_log, "ImageFormatter delegateSerialize start");
