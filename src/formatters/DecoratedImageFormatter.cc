...
{
    LOGL_TRACE9(_log, "DecoratedImageFormatter write start");
    ...
    if (typeid(*storage) == typeid(BoostStorage)) {
        LOGL_TRACE9(_log, "DecoratedImageFormatter write BoostStorage");
        BoostStorage* boost = dynamic_cast<BoostStorage*>(storage.get());
        boost->getOArchive() & *ip;
        LOGL_TRACE9(_log, "DecoratedImageFormatter write end");
        return;
    } else if (typeid(*storage) == typeid(XmlStorage)) {
        LOGL_TRACE9(_log, "DecoratedImageFormatter write XmlStorage");
        ...
        LOGL_TRACE9(_log, "DecoratedImageFormatter write FitsStorage");
...
{
    LOGL_TRACE9(_log, "DecoratedImageFormatter read start");
    if (typeid(*storage) == typeid(BoostStorage)) {
        LOGL_TRACE9(_log, "DecoratedImageFormatter read BoostStorage");
        BoostStorage* boost = dynamic_cast<BoostStorage*>(storage.get());
        DecoratedImage<ImagePixelT>* ip = new DecoratedImage<ImagePixelT>;
        boost->getIArchive() & *ip;
        LOGL_TRACE9(_log, "DecoratedImageFormatter read end");
        return ip;
    } else if (typeid(*storage) == typeid(XmlStorage)) {
        LOGL_TRACE9(_log, "DecoratedImageFormatter read XmlStorage");
        XmlStorage* boost = dynamic_cast<XmlStorage*>(storage.get());
        DecoratedImage<ImagePixelT>* ip = new DecoratedImage<ImagePixelT>;
        ...
        LOGL_TRACE9(_log, "DecoratedImageFormatter read FitsStorage");
        FitsStorage* fits = dynamic_cast<FitsStorage*>(storage.get());
...
{
    LOGL_TRACE9(_log, "DecoratedImageFormatter delegateSerialize start");
