...
std::shared_ptr<TransformPoint2ToPoint2> makeAffineTransformPoint2(Extent2D const &offset,
                                                                   Angle const &rotation, double scale) {
    ...
    return std::make_shared<TransformPoint2ToPoint2>(affineMap, true);
}
