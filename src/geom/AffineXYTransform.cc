...
AffineTransform AffineXYTransform::getForwardTransform() const { return _forwardAffineTransform; }

AffineTransform AffineXYTransform::getReverseTransform() const { return _reverseAffineTransform; }
}  // namespace geom
}  // namespace afw
}  // namespace lsst
