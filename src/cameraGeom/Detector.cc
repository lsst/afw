...
{
    return afwGeom::Point2I::makeXY(pos[0]/_pixelSize, pos[1]/_pixelSize);
}
...
{
    afwGeom::Point2I const centerPixel = afwGeom::Point2I::makeXY(dimensions[0]/2, dimensions[1]/2);
                                         ...
                                         )
{
    ...
    _allPixels =
        cameraGeom::detail::rotateBBoxBy90(_allPixels,
                                           afwGeom::Extent2I::makeXY(getAllPixels(false).getWidth(),
                                                                     getAllPixels(false).getHeight()), n90);
    _trimmedAllPixels =
        cameraGeom::detail::rotateBBoxBy90(_trimmedAllPixels,
                                           afwGeom::Extent2I::makeXY(getAllPixels(true).getWidth(),
                                                                     getAllPixels(true).getHeight()), n90);
        
    if (n90 == 1 || n90 == 3) {
        _size = afwGeom::Extent2D::makeXY(_size[1], _size[0]);
    }
}
