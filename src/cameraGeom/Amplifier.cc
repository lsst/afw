 ...
 * _min+_max BoxKey defined in afw/table/aggregates.h) - while AmpInfoRecord
 * will be removed shortly, its schema lives on in persisted Amplifiers, and
 * we don't want to break our ability to read those.
 */
...
public:
    ...
    // Return True if all internal keys point to actual fields in a schema.
