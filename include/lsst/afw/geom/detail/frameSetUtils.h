...
/**
Read an LSST sky WCS FrameSet from a FITS header: 0,0 is the lower left corner of the image.
...
- base: an ast::Frame with domain "PIXELS0": pixels with 0,0 the lower left corner of the image
- An ast::Frame with domain "GRID": pixels with 1,1 the lower left corner of the image
- An ast::Frame with domain "IWCS": FITS-WCS intermediate world coordinate systems
