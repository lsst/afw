...
/** @file
  ...
  *
  * There are currently no afw::image exceptions.  If there ever are, we
  * need to refactor the lsst::lex::exceptions code (maybe the m4 file)
  * to allow us to define new Exceptions without repeating that boilerplate
  *
  * @ingroup afw
  */
