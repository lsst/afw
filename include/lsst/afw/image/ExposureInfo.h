...
public:
    ...
    std::shared_ptr<TransmissionCurve> getTransmissionCurve() const { return _transmissionCurve; }

    /// Set the exposure's transmission curve.
    void setTransmissionCurve(std::shared_ptr<TransmissionCurve> tc) { _transmissionCurve = tc; }
...
private:
    ...
    std::shared_ptr<TransmissionCurve> _transmissionCurve;
};
}
}
}  // lsst::afw::image
