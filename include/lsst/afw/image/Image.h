...
//
template<typename PixelT>
class ImageBase : public daf::base::Persistable,
                  public daf::base::Citizen {
private:
    typedef typename afw::image::detail::types_traits<PixelT>::view_t _view_t;
    typedef typename afw::image::detail::types_traits<PixelT>::const_view_t _const_view_t;
...
public:        
    ...
    std::pair<int, double> positionToIndex(
        ...
        afw::image::xOrY const xy ///< Is this a column or row coordinate?
    ) const {
...
public:
    ...
    explicit Image(lsst::ndarray::Array<PixelT,2,1> const & array, bool deep = false,
        ...
        ImageBase<PixelT>(array, deep, xy0) {}
    ...
    void operator+=(afw::math::Function2<double> const& function);
...
private:
    LSST_PERSIST_FORMATTER(afw::formatters::ImageFormatter<PixelT>)
};
