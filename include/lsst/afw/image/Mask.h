...
namespace image {
    ...
    public:
        ...
        typename ImageBase<MaskPixelT>::PixelReference operator()(int x, int y, bool);
        typename ImageBase<MaskPixelT>::PixelConstReference operator()(int x, int y, bool) const;
        bool operator()(int x, int y, int plane, bool) const;
