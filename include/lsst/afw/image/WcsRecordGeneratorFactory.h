// -*- lsst-c++ -*-
#ifndef AFW_IMAGE_WcsRecordGeneratorFactory_h_INCLUDED
#define AFW_IMAGE_WcsRecordGeneratorFactory_h_INCLUDED
 ...
 */
class WcsRecordGeneratorFactory : private boost::noncopyable {
public:
    ...
    explicit WcsRecordGeneratorFactory(std::string const & name);

    /// Use the factory to create a Wcs object.
    virtual PTR(Wcs) operator()(table::RecordInputGeneratorSet const & inputs) const;

    virtual ~WcsRecordGeneratorFactory() {}

};

}}} // namespace lsst::afw::image

#endif // !AFW_IMAGE_WcsRecordGeneratorFactory_h_INCLUDED
