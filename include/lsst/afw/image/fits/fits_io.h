...
/// Throws lsst::afw::image::cfitsio::FitsErrorException if the location does not correspond to a valid FITS file
...
/// extension.  Throws lsst::afw::image::cfitsio::FitsErrorException if the file is not a valid FITS file, or
...
/// Throws lsst::afw::image::cfitsio::FitsErrorException if it fails to create the file.
template <typename View>
