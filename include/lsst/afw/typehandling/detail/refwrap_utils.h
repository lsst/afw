...
// contain std::reference_wrapper types.  Because reference_wrapper doesn't
...
//
// With sufficient cleverness, this could probably be made to work with any
// number of arguments of reference_wrapper and non-reference_wrapper types,
// unwrapping only the former.  But that cleverness would probably make this
