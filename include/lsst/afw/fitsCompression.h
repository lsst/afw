...
///
/// These have a trailing underscore to avoid conflict with CFITSIO's
/// preprocessor macros (the trailing underscore is dropped in the Python
/// bindings).  Not all FITS compression algorithms are supported.
