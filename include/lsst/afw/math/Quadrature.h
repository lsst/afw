...
double romberg(FunctionT &func, double const a, double const b, double const eps = 1.0e-6);

double romberg2D(IntegrandBase &func, double const x1, double const x2,
