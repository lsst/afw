...
void lsst::fw::kernel::convolve(
    ...
    if (kernel.isSpatiallyVarying()) {
        ...
        lsst::fw::Trace("lsst.fw.kernel.convolve", 1, "kernel is spatially varying");
        ...
        lsst::fw::Trace("lsst.fw.kernel.convolve", 1, "kernel is spatially invariant");
        KernelT kSum;
...
inline void lsst::fw::kernel::_copyRegion(
    ...
    lsst::fw::Trace("lsst.fw.kernel._copyRegion", 1, str(boost::format(
