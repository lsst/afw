...
public:
    ...
    // for this example we have an analytic answer to check
    IntegrandT getAnalyticVolume(IntegrandT const x1, IntegrandT const x2, IntegrandT const y1,
                                 IntegrandT const y2) {
...
int main() {
    ...
    std::cout << "1D integrate: functor = " << parab_area_integrate
              << "  function = " << parab_area_integrate_func << "  analytic = " << parab_area_analytic
              << std::endl;
