...
void wrapAmplifier(lsst::utils::python::WrapperCollection &wrappers) {
    wrappers.addInheritanceDependency("lsst.afw.table");
     wrappers.wrapType(py::enum_<ReadoutCorner>(wrappers.module,"ReadoutCorner"),
            [](auto &mod,auto &enm) {
      ...
      wrappers.wrapType( py::enum_<AssemblyState>(wrappers.module,"AssemblyState"),
            [](auto &mod,auto &enm) {
                enm.value("RAW", AssemblyState::RAW);
                    enm.value("SCIENCE", AssemblyState::SCIENCE);
            });
    auto amplifier=wrappers.wrapType( PyAmplifier(wrappers.module,"Amplifier"),
            [](auto &mod,auto &cls) {
     ...
     wrappers.wrapType( PyAmplifierBuilder  (amplifier,"Builder"),
            [](auto &mod,auto &cls) {
