...
PYBIND11_PLUGIN(_coord) {
    ...
    /* Operators */
    clsIcrsCoord.def("__str__", [](IcrsCoord &c) {
        std::ostringstream os;
        os << c;
        return os.str();
    });
    ...
    /* Operators */
    clsFk5Coord.def("__str__", [](Fk5Coord &c) {
        std::ostringstream os;
        os << c;
        return os.str();
    });
    ...
    /* Operators */
    clsGalacticCoord.def("__str__", [](GalacticCoord &c) {
        std::ostringstream os;
        os << c;
        return os.str();
    });
    ...
    /* Operators */
    clsEclipticCoord.def("__str__", [](EclipticCoord &c) {
        std::ostringstream os;
        os << c;
        return os.str();
    });
    ...
    /* Operators */
    clsTopocentricCoord.def("__str__", [](TopocentricCoord &c) {
        std::ostringstream os;
        os << c;
        return os.str();
    });
