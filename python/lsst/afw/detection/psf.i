...
%declareNumPyConverters(ndarray::Array<lsst::afw::detection::LocalPsf::Pixel,1,0>);
%declareNumPyConverters(ndarray::Array<lsst::afw::detection::LocalPsf::Pixel const,1,0>);
