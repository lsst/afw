...
PYBIND11_PLUGIN(_angle) {
    ...
    /* Members */
    mod.attr("radians") = py::cast(new AngleUnit(1.0));
    mod.attr("degrees") = py::cast(new AngleUnit(PI/180.0));
    mod.attr("hours") = py::cast(new AngleUnit(PI*15.0/180.0));
    mod.attr("arcminutes") = py::cast(new AngleUnit(PI/60/180.0));
    mod.attr("arcseconds") = py::cast(new AngleUnit(PI/180.0/3600.0));
    ...
    mod.attr("NullAngle") = py::cast(new Angle(-1000000., degrees));
