...
PYBIND11_PLUGIN(_extent) {
    ...
    clsExtent2I.def("__floordiv__", [](Extent<int,2> &e, int val) { return floor(e / static_cast<double>(val)); });
    clsExtent3I.def("__floordiv__", [](Extent<int,3> &e, int val) { return floor(e / static_cast<double>(val)); });
    ...
    clsExtent2I.def("__ifloordiv__", [](Extent<int,2> &e, int val) {  e = floor(e / static_cast<double>(val)); return &e;});
    clsExtent3I.def("__ifloordiv__", [](Extent<int,3> &e, int val) {  e = floor(e / static_cast<double>(val)); return &e;});

    clsExtent2I.def("__idiv__", [](Extent<int,2> &e, int val) {  e = floor(e / static_cast<double>(val)); return &e;});
    clsExtent3I.def("__idiv__", [](Extent<int,3> &e, int val) {  e = floor(e / static_cast<double>(val)); return &e;});
    clsExtent2D.def("__idiv__", [](Extent<double,2> &e, double val) {  e /= val; return &e;});
    clsExtent3D.def("__idiv__", [](Extent<double,3> &e, double val) {  e /= val; return &e;});
    ...
    clsExtent2D.def("__itruediv__", [](Extent<double,2> &e, double val) {  e /= val; return &e;});
    clsExtent3D.def("__itruediv__", [](Extent<double,3> &e, double val) {  e /= val; return &e;});

    clsExtent2I.def("__iadd__", [](Extent<int,2> &lhs, Extent<int,2> &rhs) { lhs += rhs; return &lhs; });
    clsExtent3I.def("__iadd__", [](Extent<int,3> &lhs, Extent<int,3> &rhs) { lhs += rhs; return &lhs; });
    clsExtent2D.def("__iadd__", [](Extent<double,2> &lhs, Extent<double,2> &rhs) { lhs += rhs; return &lhs; });
    clsExtent3D.def("__iadd__", [](Extent<double,3> &lhs, Extent<double,3> &rhs) { lhs += rhs; return &lhs; });
    clsExtent2D.def("__iadd__", [](Extent<double,2> &lhs, Extent<int,2> &rhs) { lhs += rhs; return &lhs; });
    clsExtent3D.def("__iadd__", [](Extent<double,3> &lhs, Extent<int,3> &rhs) { lhs += rhs; return &lhs; });

    clsExtent2I.def("__isub__", [](Extent<int,2> &lhs, Extent<int,2> &rhs) { lhs -= rhs; return &lhs; });
    clsExtent3I.def("__isub__", [](Extent<int,3> &lhs, Extent<int,3> &rhs) { lhs -= rhs; return &lhs; });
    clsExtent2D.def("__isub__", [](Extent<double,2> &lhs, Extent<double,2> &rhs) { lhs -= rhs; return &lhs; });
    clsExtent3D.def("__isub__", [](Extent<double,3> &lhs, Extent<double,3> &rhs) { lhs -= rhs; return &lhs; });
    clsExtent2D.def("__isub__", [](Extent<double,2> &lhs, Extent<int,2> &rhs) { lhs -= rhs; return &lhs; });
    clsExtent3D.def("__isub__", [](Extent<double,3> &lhs, Extent<int,3> &rhs) { lhs -= rhs; return &lhs; });

    clsExtent2I.def("__imul__", [](Extent<int,2> &lhs, int rhs) { lhs *= rhs; return &lhs; });
    clsExtent3I.def("__imul__", [](Extent<int,3> &lhs, int rhs) { lhs *= rhs; return &lhs; });
    clsExtent2D.def("__imul__", [](Extent<double,2> &lhs, int rhs) { lhs *= rhs; return &lhs; });
    clsExtent2D.def("__imul__", [](Extent<double,2> &lhs, double rhs) { lhs *= rhs; return &lhs; });
    clsExtent3D.def("__imul__", [](Extent<double,3> &lhs, int rhs) { lhs *= rhs; return &lhs; });
    clsExtent3D.def("__imul__", [](Extent<double,3> &lhs, double rhs) { lhs *= rhs; return &lhs; });
