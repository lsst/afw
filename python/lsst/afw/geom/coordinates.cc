...
void declareExtentOperators(py::module & mod, PyExtent<int,N> & clsI, PyExtent<double,N> & clsD) {
    ...
    clsI.def("__div__",
             [](Extent<int, N> const &self, int other) { return floor(self / static_cast<double>(other)); },
             py::is_operator());
    clsI.def("__div__", [](Extent<int, N> const &self, double other) { return self / other; },
             py::is_operator());
    clsD.def("__div__", [](Extent<double, N> const &self, double other) { return self / other; },
             py::is_operator());
    ...
    clsI.def("__idiv__", [](Extent<int, N> &self, int other) -> Extent<int, N> & {
        self = floor(self / static_cast<double>(other));
        return self;
    });
    clsD.def("__idiv__", [](Extent<double, N> &self, double other) -> Extent<double, N> & {
        self /= other;
        return self;
    });
