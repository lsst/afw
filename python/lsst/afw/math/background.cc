...
void declareMakeBackground(py::module & mod) {
    mod.def("makeBackground", makeBackground<ImageT>,
            "img"_a, "bgCtrl"_a);
}
...
PYBIND11_PLUGIN(_background) {
    ...
    py::class_<BackgroundControl, std::shared_ptr<BackgroundControl>> clsBackgroundControl(mod, "BackgroundControl");

    /* Constructors */
    clsBackgroundControl.def(py::init<int const, int const, StatisticsControl const, Property const, ApproximateControl const>(),
            "nxSample"_a,
            "nySample"_a,
            "sctrl"_a=StatisticsControl(),
            "prop"_a=MEANCLIP,
            "actrl"_a=ApproximateControl(ApproximateControl::UNKNOWN, 1));
    clsBackgroundControl.def(py::init<int const, int const, StatisticsControl const, std::string const &, ApproximateControl const>(),
            "nxSample"_a,
            "nySample"_a,
            "sctrl"_a,
            "prop"_a,
            "actrl"_a=ApproximateControl(ApproximateControl::UNKNOWN, 1));
    clsBackgroundControl.def(py::init<Interpolate::Style const, int const, int const, UndersampleStyle const, StatisticsControl const, Property const, ApproximateControl const>(),
            "style"_a,
            "nxSample"_a=10,
            "nySample"_a=10,
            ...
            "prop"_a=MEANCLIP,
            "actrl"_a=ApproximateControl(ApproximateControl::UNKNOWN, 1));
    clsBackgroundControl.def(py::init<std::string const &, int const, int const, std::string const &, StatisticsControl const, std::string const &, ApproximateControl const>(),
            "style"_a,
            "nxSample"_a=10,
            "nySample"_a=10,
            "undersampleStyle"_a="THROW_EXCEPTION",
    ...
    clsBackgroundControl.def("setInterpStyle", (void (BackgroundControl::*)(Interpolate::Style const)) &BackgroundControl::setInterpStyle);
    clsBackgroundControl.def("setInterpStyle", (void (BackgroundControl::*)(std::string const &)) &BackgroundControl::setInterpStyle);
    clsBackgroundControl.def("setUndersampleStyle", (void (BackgroundControl::*)(UndersampleStyle const)) &BackgroundControl::setUndersampleStyle);
    clsBackgroundControl.def("setUndersampleStyle", (void (BackgroundControl::*)(std::string const &)) &BackgroundControl::setUndersampleStyle);
    ...
    /* Constructors */
    clsBackgroundMI.def(py::init<geom::Box2I const, image::MaskedImage<typename Background::InternalPixelT> const&>(),
    ...
    clsBackgroundMI.def("getPixel", (double (BackgroundMI::*)(Interpolate::Style const, int const, int const) const) &BackgroundMI::getPixel);
    clsBackgroundMI.def("getPixel", (double (BackgroundMI::*)(int const, int const) const) &BackgroundMI::getPixel);
