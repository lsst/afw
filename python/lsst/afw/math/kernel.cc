...
PYBIND11_PLUGIN(_kernel) {
    ...
    clsKernel.def("computeImage", &Kernel::computeImage,
    ...
    clsKernel.def("setKernelParameters", (void (Kernel::*)(std::vector<double> const &)) &Kernel::setKernelParameters);
    clsKernel.def("setKernelParameters", (void (Kernel::*)(std::pair<double, double> const &)) &Kernel::setKernelParameters);
    clsKernel.def("setSpatialParameters", &Kernel::setSpatialParameters);
    clsKernel.def("computeKernelParametersFromSpatialModel", &Kernel::computeKernelParametersFromSpatialModel);
    ...
    clsFixedKernel.def(py::init<lsst::afw::image::Image<Kernel::Pixel> const &>(),
                       "image"_a);
    ...
    py::class_<DeltaFunctionKernel, std::shared_ptr<DeltaFunctionKernel>, Kernel> clsDeltaFunctionKernel(mod, "DeltaFunctionKernel");

    clsDeltaFunctionKernel.def(py::init<int, int, lsst::afw::geom::Point2I const &>(),
                               "width"_a, "height"_a, "point"_a);
    ...
    py::class_<LinearCombinationKernel, std::shared_ptr<LinearCombinationKernel>, Kernel> clsLinearCombinationKernel(mod, "LinearCombinationKernel");
    ...
    clsLinearCombinationKernel.def(py::init<KernelList const &, std::vector<Kernel::SpatialFunctionPtr> const &>(),
