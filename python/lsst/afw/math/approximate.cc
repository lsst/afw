...
void declareApproximate(py::module & mod, std::string const & suffix) {
    ...
    cls.def("getMaskedImage", &Class::getMaskedImage,
            "orderX"_a=-1, "orderY"_a=-1);
...
PYBIND11_PLUGIN(_approximate) {
    ...
    py::class_<ApproximateControl, std::shared_ptr<ApproximateControl>> clsApproximateControl(mod, "ApproximateControl");
    ...
    clsApproximateControl.def(py::init<ApproximateControl::Style, int, int, bool>(),
            "style"_a, "orderX"_a, "orderY"_a=-1, "weighting"_a=true);
