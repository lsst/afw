...
void wrapKernel(lsst::utils::python::WrapperCollection &wrappers) {
    using PyKernel = nb::class_<Kernel, std::shared_ptr<Kernel>>;
    ...
    using PyFixedKernel = nb::class_<FixedKernel, std::shared_ptr<FixedKernel>, Kernel>;
    ...
    using PyAnalyticKernel = nb::class_<AnalyticKernel, std::shared_ptr<AnalyticKernel>, Kernel>;
    ...
    using PyDeltaFunctionKernel =
            nb::class_<DeltaFunctionKernel, std::shared_ptr<DeltaFunctionKernel>, Kernel>;
    wrappers.wrapType(
    ...
    using PyLinearCombinationKernel =
            nb::class_<LinearCombinationKernel, std::shared_ptr<LinearCombinationKernel>, Kernel>;
    wrappers.wrapType(
    ...
    using PySeparableKernel = nb::class_<SeparableKernel, std::shared_ptr<SeparableKernel>, Kernel>;
