...
using PyCovarianceMatrixKey = py::class_<CovarianceMatrixKey<T,N>,
                                         std::shared_ptr<CovarianceMatrixKey<T,N>>>;
...
static void declarePointKey(py::module &mod, std::string const & suffix) {
    ...
    cls.def(
        "set",
        [](PointKey<T> & self, BaseRecord & record, geom::Point<T,2> const & value) {
...
static void declareCoordKey(py::module & mod) {
    ...
    cls.def(
        "get",
        [](CoordKey & self, BaseRecord const & record) {
...
static void declareQuadrupoleKey(py::module & mod) {
    ...
    cls.def(py::init<>());
    cls.def(py::init<Key<double> const &, Key<double> const &, Key<double> const &>(),
            "ixx"_a, "iyy"_a, "ixy"_a);
    cls.def(py::init<SubSchema const &>());
...
static void declareEllipseKey(py::module & mod) {
    ...
    cls.def_static("addFields", &EllipseKey::addFields,
                   "schema"_a, "name"_a, "doc"_a, "unit"_a);
...
static void declareCovarianceMatrixKey(py::module &mod, const::std::string & suffix) {
    ...
    cls.def(
        "get",
        [](CovarianceMatrixKey<T,N> & cov, BaseRecord const & record) {
