...
PyExposureRecord declareExposureRecord(WrapperCollection &wrappers) {
    return wrappers.wrapType(PyExposureRecord(wrappers.module, "ExposureRecord"), [](auto &mod, auto &cls) {
        ...
        cls.def_prop_rw("id", &ExposureRecord::getId, &ExposureRecord::setId);
        ...
        cls.def_prop_rw("wcs", &ExposureRecord::getWcs, &ExposureRecord::setWcs);
        ...
        cls.def_prop_rw("photoCalib", &ExposureRecord::getPhotoCalib, &ExposureRecord::setPhotoCalib);
        cls.def("getApCorrMap", &ExposureRecord::getApCorrMap);
        cls.def("setApCorrMap", &ExposureRecord::setApCorrMap, "apCorrMap"_a);
        cls.def_prop_rw("apCorrMap", &ExposureRecord::getApCorrMap, &ExposureRecord::setApCorrMap);
        cls.def("getValidPolygon", &ExposureRecord::getValidPolygon);
        cls.def("setValidPolygon", &ExposureRecord::setValidPolygon);
        cls.def_prop_rw("validPolygon", &ExposureRecord::getValidPolygon, &ExposureRecord::setValidPolygon);
        ...
        cls.def_prop_rw("detector", &ExposureRecord::getDetector, &ExposureRecord::setDetector);
    });
}
