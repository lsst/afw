...
PYBIND11_PLUGIN(ampInfo) {
    ...
    auto clsAmpInfoColumnView = table::python::declareColumnView<AmpInfoRecord>(mod, "AmpInfo");
    auto clsAmpInfoCatalog = table::python::declareCatalog<AmpInfoRecord>(mod, "AmpInfo");
