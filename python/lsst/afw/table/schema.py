...
Schema.find = _schemaFind
Schema.getOrderedNames = _schemaGetOrderedNames
Schema.__iter__ = _schemaIter
Schema.checkUnits = _schemaCheckUnits
Schema.__contains__ = _schemaContains
Schema.ComparisonFlags.__and__ = schemaComparisonAnd
Schema.ComparisonFlags.__rand__ = schemaComparisonRand
...
SubSchema.find = subFind
SubSchema.asField = subAsField
...
for s in SchemaItem:
    SchemaItem[s].__getitem__ = schemaItemGet
    SchemaItem[s].__str__ = schemaItemStr
    SchemaItem[s].__repr__ = schemaItemRepr
    SchemaItem[s].getField = schemaItemGetField