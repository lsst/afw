...
void wrapMeasurement(lsst::utils::python::WrapperCollection &wrappers) {
...
PYBIND11_MODULE(photoCalib, mod) {
    lsst::utils::python::WrapperCollection wrappers(mod, "lsst.afw.image.photoCalib");
    wrappers.addInheritanceDependency("lsst.afw.typehandling");
    wrapMeasurement(wrappers);
