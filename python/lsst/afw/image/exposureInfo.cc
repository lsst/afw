...
PYBIND11_PLUGIN(exposureInfo) {
    ...
    cls.def(
        ...
        "filter"_a = Filter(),
        "metadata"_a = nullptr,
        "coaddInputs"_a = nullptr,
        "apCorrMap"_a = nullptr,
        "visitInfo"_a = nullptr,
