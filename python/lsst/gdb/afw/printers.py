...
try:
    ...
    class PrintImageCommand(gdb.Command):
        ...
        def invoke (self, args, fromTty):
            ...
            parser.add_argument("width", type=int, help="Width of patch to print", default=1, nargs="?")
            parser.add_argument("height", type=int, help="Height of patch to print", default=1, nargs="?")
