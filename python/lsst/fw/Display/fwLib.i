...
%{
typedef vw::PixelGray<float> PixelType;
typedef vw::PixelGray<uint8> MaskPixelType;
%}

%ignore vw::ImageView<PixelType>::origin;
...
%template(ImageBaseFloat) vw::ImageViewBase<vw::ImageView<PixelType> >;
%template(ImageFloat) vw::ImageView<PixelType>;
...
%template(readFloat) lsst::image::read<PixelType>;

%template(writeFitsFloat) writeFits<PixelType>;
%template(writeFitsFileFloat) writeFitsFile<PixelType>;
