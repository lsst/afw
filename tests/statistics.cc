...
BOOST_AUTO_TEST_CASE(StatisticsRamp) { /* parasoft-suppress  LsstDm-3-2a LsstDm-3-4a LsstDm-4-6 LsstDm-5-25
                                          "Boost non-Std" */
...
BOOST_AUTO_TEST_CASE(StatisticsTestAllNanButOne) { /* parasoft-suppress  LsstDm-3-2a LsstDm-3-4a LsstDm-4-6
    ...
    {
        math::Statistics stats =
                math::makeStatistics(img, math::NPOINT | math::STDEV | math::MEAN | math::MIN | math::MAX);
        double const testmean = stats.getValue(math::MEAN);
        double const teststdev = stats.getValue(math::STDEV);
