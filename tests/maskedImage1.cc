...
int test(int argc, char **argv) {
    ...
    *testFlat /= 20000.0;
    ...
    lsst::geom::Box2I region(lsst::geom::Point2I(100, 600), lsst::geom::Extent2I(200, 300), false);
    ...
    lsst::geom::Box2I region2(lsst::geom::Point2I(80, 110), lsst::geom::Extent2I(20, 30), false);
