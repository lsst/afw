...
class BootprintTestCase(unittest.TestCase):
    def setUp(self):
        self.spanRad = 4
        self.regionRad = 10
        self.spans = afwGeom.SpanSet.spanSetFromShape(self.spanRad,
                                                      afwGeom.Stencil.BOX)
    ...
    def testGetSetSpans(self):
        ...
        '''
        self.assertTrue(self.footprint.getSpans() == self.spans)
        self.assertTrue(self.footprint.spans == self.spans)
        tempSpanSet = afwGeom.SpanSet.spanSetFromShape(2, afwGeom.Stencil.BOX)
        self.footprint.setSpans(tempSpanSet)
        self.assertTrue(self.footprint.spans == tempSpanSet)
        # reset back to origional with property
    ...
    def testPeakFunctionality(self):
        ...
        self.assertTrue("extra" in names)
    ...
    def testGeometry(self):
        ...
        self.footprint.shift(afwGeom.ExtentI(-offset, -offset))
        ...
        self.assertTrue(memberPoint in self.footprint)
    ...
    def testMutationFunctionality(self):
        ...
        # Test erode
        kernelRad = 1
        kernel = afwGeom.SpanSet.spanSetFromShape(kernelRad,
                                                  afwGeom.Stencil.BOX)
