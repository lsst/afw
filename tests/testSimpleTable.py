...
class SimpleTableTestCase(lsst.utils.tests.TestCase):
    ...
    def testTicket2308(self):
        ...
        print("type(outputTable1)=", type(outputTable1))
        print("type(outputTable2)=", type(outputTable2))
        print("type(outputRecord1)=", type(outputRecord1))
        print("type(outputRecord2)=", type(outputRecord2))
