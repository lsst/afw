...
class SimpleTableTestCase(unittest.TestCase):
    ...
    def testRecordAccess(self):
        ...
        k5 = schema.addField("f5", type="PointI4")
        k6 = schema.addField("f6", type="PointF4")
        k7 = schema.addField("f7", type="PointF8")
        k8 = schema.addField("f8", type="MomentsF4")
        k9 = schema.addField("f9", type="MomentsF8")
        k10 = schema.addField("f10", type="ArrayF4", size=4)
        k11 = schema.addField("f11", type="ArrayF8", size=5)
        k12 = schema.addField("f12", type="CovF4", size=3)
        k13 = schema.addField("f13", type="CovF8", size=4)
        k14 = schema.addField("f14", type="CovPointF4")
        k15 = schema.addField("f15", type="CovPointF8")
        k16 = schema.addField("f16", type="CovMomentsF4")
        k17 = schema.addField("f17", type="CovMomentsF8")
    ...
    def testColumnView(self):
        ...
        k4 = schema.addField("f4", type="ArrayF4", size=2)
        k5 = schema.addField("f5", type="ArrayF8", size=3)
