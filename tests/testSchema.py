...
class SchemaTestCase(unittest.TestCase):
    ...
    def testComparison(self):
        ...
        self.assertFalse(cmp1 & lsst.afw.table.Schema.EQUAL_NAMES)
        self.assertFalse(cmp1 & lsst.afw.table.Schema.EQUAL_DOCS)
        self.assertFalse(cmp1 & lsst.afw.table.Schema.EQUAL_UNITS)
        ...
        self.assertFalse(schema3.contains(schema1))
        ...
        self.assertFalse(cmp2 & lsst.afw.table.Schema.EQUAL_KEYS)
        self.assertFalse(cmp2 & lsst.afw.table.Schema.EQUAL_UNITS)
