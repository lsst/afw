...
class TanSipTestCases(unittest.TestCase):
    ...
    def setUp(self):
        ...
        metadata.set('CRVAL1',  22.1136691404219)
        metadata.set('CTYPE2', 'DEC--TAN-SIP')
        metadata.set('CRPIX2',  0.0)
        metadata.set('CRVAL2', -0.1147084491242522)
        metadata.set('CD1_1',  -5.557012868767685E-05)
        metadata.set('CD1_2',   8.612902244741679E-09)
        metadata.set('CD2_1',   9.142016644499551E-09)
        metadata.set('CD2_2',   5.556972887000046E-05)
        metadata.set('RADESYS', 'FK5')
        metadata.set('EQUINOX',  2000.0)
        metadata.set('A_ORDER',  2)
        metadata.set('A_0_2',  1.212767765974218E-09)
        metadata.set('A_1_1', -1.513523887718658E-09)
        metadata.set('A_2_0', -1.853226276965959E-09)
        metadata.set('B_ORDER',  2)
        metadata.set('B_0_2',  1.396136742490582E-10)
        metadata.set('B_1_1', -2.017605162108109E-09)
        metadata.set('B_2_0', -1.718567550120541E-09)
        metadata.set('CDELT1',  5.555555555555556E-05)
        metadata.set('CDELT2',  5.555555555555556E-05)
        metadata.set('AP_ORDER',  2)
        metadata.set('AP_0_2', -1.21284736702594E-09)
        metadata.set('AP_1_1',  1.513327296944833E-09)
        metadata.set('AP_2_0',  1.853061707063949E-09)
        metadata.set('BP_ORDER',  2)
        metadata.set('BP_0_2', -1.396563965515465E-10)
        metadata.set('BP_1_1',  2.017652363438723E-09)
        metadata.set('BP_2_0',  1.71862166205852E-09)
    ...
    def evalTanSip(self, ra, dec, x, y):
        ...
        self.assertAlmostEqual(xy[0], x, 5)
        self.assertAlmostEqual(xy[1], y, 5)
