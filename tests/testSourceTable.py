...
class SourceTableTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.centroidKey = self.schema.addField("b", type="PointF8")
        self.centroidErrKey = self.schema.addField("b.err", type="CovPointF8")
        self.centroidFlagKey = self.schema.addField("b.flags", type="Flag")
        self.shapeKey = self.schema.addField("c", type="MomentsF8")
        self.shapeErrKey = self.schema.addField("c.err", type="CovMomentsF8")
