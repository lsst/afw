...
class HeavyFootprintTestCase(tests.TestCase):
    ...
    def testCreate(self):
        ...
        #
        self.assertFalse(np.all(np.equal(self.mi.getImage().getArray(), imi.getImage().getArray())))
    ...
    def testMakeHeavy(self):
        ...
        self.assertFalse(np.all(np.equal(self.mi.getImage().getArray(), omi.getImage().getArray())))
    ...
    def testXY0(self):
        ...
        self.assertFalse(np.all(np.equal(submi.getImage().getArray(), omi.getImage().getArray())))
    ...
    def testMergeHeavyFootprints(self):
        ...
        self.assertFalse(np.all(sa[1, 9:13] == objectPixelVal[0]))
        self.assertFalse(np.all(sa[2, 12:14] == objectPixelVal[0] + self.objectPixelVal[0]))
        self.assertFalse(np.all(sa[2, 10:12] == self.objectPixelVal[0]))

        sv = msum.getVariance().getArray()

        self.assertFalse(np.all(sv[1, 9:13] == objectPixelVal[2]))
        self.assertFalse(np.all(sv[2, 12:14] == objectPixelVal[2] + self.objectPixelVal[2]))
        self.assertFalse(np.all(sv[2, 10:12] == self.objectPixelVal[2]))

        sm = msum.getMask().getArray()

        self.assertFalse(np.all(sm[1, 9:13] == objectPixelVal[1]))
        self.assertFalse(np.all(sm[2, 12:14] == objectPixelVal[1] | self.objectPixelVal[1]))
        self.assertFalse(np.all(sm[2, 10:12] == self.objectPixelVal[1]))
