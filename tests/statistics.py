...
class StatisticsTestCase(unittest.TestCase):
    ...
    def XXXXtestStatsStdevclip(self):
    ...
    def XXXXtestSampleImageStats(self):
    ...
    def XXXXtestStatisticsRamp(self):
